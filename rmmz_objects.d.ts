...
declare class Game_Temp {
    ...
    initialize(): void;
    _isPlaytest: boolean | undefined;
    _destinationX: any;
    _destinationY: any;
    _touchTarget: any;
    _touchState: any;
    _needsBattleRefresh: boolean | undefined;
    _commonEventQueue: any[] | undefined;
    _animationQueue: any[] | undefined;
    _balloonQueue: any[] | undefined;
    _lastActionData: number[] | undefined;
    isPlaytest(): boolean | undefined;
    ...
    isBattleRefreshRequested(): boolean | undefined;
...
declare class Game_System {
    constructor(...args: any[]);
    initialize(): void;
    _saveEnabled: boolean | undefined;
    _menuEnabled: boolean | undefined;
    _encounterEnabled: boolean | undefined;
    _formationEnabled: boolean | undefined;
    _battleCount: number | undefined;
    _winCount: number | undefined;
    _escapeCount: number | undefined;
    _saveCount: number | undefined;
    _versionId: any;
    _savefileId: any;
    _framesOnSave: any;
    _bgmOnSave: any;
    ...
    isSaveEnabled(): boolean | undefined;
    disableSave(): void;
    enableSave(): void;
    isMenuEnabled(): boolean | undefined;
    disableMenu(): void;
    enableMenu(): void;
    isEncounterEnabled(): boolean | undefined;
    disableEncounter(): void;
    enableEncounter(): void;
    isFormationEnabled(): boolean | undefined;
    disableFormation(): void;
    enableFormation(): void;
    battleCount(): number | undefined;
    winCount(): number | undefined;
    escapeCount(): number | undefined;
...
declare class Game_Screen {
    ...
    _shakeSpeed: any;
    _shakeDuration: any;
    _shakeDirection: number | undefined;
...
declare class Game_Picture {
    ...
    _wholeDuration: any;
    _easingType: any;
    _easingExponent: number | undefined;
    initTone(): void;
    _tone: any;
    _toneTarget: any;
    _toneDuration: any;
...
declare class Game_Action {
    ...
    evaluateWithTarget(target: any): number | undefined;
...
declare class Game_ActionResult {
    ...
    evaded: boolean | undefined;
    physical: boolean | undefined;
    drain: boolean | undefined;
    critical: boolean | undefined;
    success: boolean | undefined;
    hpAffected: boolean | undefined;
    hpDamage: number | undefined;
    mpDamage: number | undefined;
    tpDamage: number | undefined;
    addedStates: any[] | undefined;
    removedStates: any[] | undefined;
    addedBuffs: any[] | undefined;
    addedDebuffs: any[] | undefined;
    removedBuffs: any[] | undefined;
...
declare class Game_BattlerBase {
    ...
    clearParamPlus(): void;
    _paramPlus: number[] | undefined;
    clearStates(): void;
    _states: any[] | undefined;
    _stateTurns: {} | undefined;
    ...
    clearBuffs(): void;
    _buffs: number[] | undefined;
    _buffTurns: number[] | undefined;
    ...
    canEquipWeapon(item: any): any;
    canEquipArmor(item: any): any;
    guardSkillId(): number;
    canAttack(): any;
    canGuard(): any;
}
...
declare class Game_Battler {
    ...
    _result: Game_ActionResult | undefined;
    _actionState: any;
    _lastTargetIndex: any;
    _damagePopup: boolean | undefined;
    _effectType: any;
    _motionType: any;
    _weaponImageId: any;
    _motionRefresh: boolean | undefined;
    _selected: boolean | undefined;
    _tpbState: string | undefined;
    _tpbChargeTime: number | undefined;
    _tpbCastTime: number | undefined;
    _tpbIdleTime: number | undefined;
    _tpbTurnCount: number | undefined;
    _tpbTurnEnd: boolean | undefined;
    ...
    select(): void;
    deselect(): void;
    isDamagePopupRequested(): boolean | undefined;
    isEffectRequested(): boolean;
    isMotionRequested(): boolean;
    isWeaponAnimationRequested(): boolean;
    isMotionRefreshRequested(): boolean | undefined;
    ...
    isTpbTurnEnd(): boolean | undefined;
    initTpbTurn(): void;
    startTpbTurn(): void;
    makeTpbActions(): void;
    onTpbTimeout(): void;
    ...
    isStateAddable(stateId: any): any;
...
declare class Game_Actor {
    ...
    _battlerName: any;
    _exp: {} | undefined;
    _skills: any[] | undefined;
    _equips: any[] | undefined;
    _actionInputIndex: number | undefined;
    _lastMenuSkill: Game_Item | undefined;
    _lastBattleSkill: Game_Item | undefined;
...
declare class Game_Unit {
    constructor(...args: any[]);
    initialize(): void;
    _inBattle: boolean | undefined;
    inBattle(): boolean | undefined;
    members(): never[];
    aliveMembers(): never[];
    deadMembers(): never[];
    movableMembers(): never[];
    clearActions(): void;
    agility(): number;
    tgrSum(): number;
    randomTarget(): null;
...
declare class Game_Party {
    ...
    _lastItem: Game_Item | undefined;
    _menuActorId: any;
    _targetActorId: any;
    _actors: any[] | undefined;
    initAllItems(): void;
    _items: {} | undefined;
    _weapons: {} | undefined;
    _armors: {} | undefined;
    ...
    equipItems(): any[];
    allItems(): any[];
    itemContainer(item: any): {} | null | undefined;
...
declare class Game_Troop {
    constructor(...args: any[]);
    initialize(): void;
    _interpreter: Game_Interpreter | undefined;
    ...
    clear(): void;
    _troopId: any;
    _eventFlags: {} | undefined;
    _enemies: any[] | undefined;
    _turnCount: number | undefined;
    _namesCount: {} | undefined;
    troop(): any;
...
declare class Game_Map {
    ...
    _commonEvents: any[] | undefined;
    _vehicles: any[] | undefined;
    _displayX: any;
    _displayY: any;
    _nameDisplay: boolean | undefined;
    ...
    _needsRefresh: boolean | undefined;
    isEventRunning(): boolean;
    tileWidth(): any;
    tileHeight(): any;
    bushDepth(): number;
    ...
    battleback2Name(): any;
    requestRefresh(): void;
    isNameDisplayEnabled(): boolean | undefined;
...
declare class Game_CommonEvent {
    ...
    list(): any;
    refresh(): void;
    _interpreter: Game_Interpreter | null | undefined;
    isActive(): any;
    update(): void;
}
...
declare class Game_CharacterBase {
    ...
    _balloonId: number | undefined;
    _animationPlaying: boolean | undefined;
    _balloonPlaying: boolean | undefined;
    _animationCount: number | undefined;
    _stopCount: number | undefined;
    _jumpCount: number | undefined;
    _jumpPeak: number | undefined;
    ...
    startAnimation(): void;
    startBalloon(): void;
    isAnimationPlaying(): boolean | undefined;
    isBalloonPlaying(): boolean | undefined;
    endAnimation(): void;
    endBalloon(): void;
}
...
declare class Game_Character {
    ...
    initialize(): void;
    initMembers(): void;
    _moveRouteForcing: boolean | undefined;
    _moveRoute: any;
    _moveRouteIndex: any;
    ...
    isMoveRouteForcing(): boolean | undefined;
...
declare class Game_Player {
    ...
    _vehicleGettingOn: boolean | undefined;
    _vehicleGettingOff: boolean | undefined;
    _dashing: any;
    _needsMapReload: boolean | undefined;
    _transferring: boolean | undefined;
    _newMapId: any;
    _newX: any;
    _newY: any;
    _newDirection: any;
    _fadeType: any;
    _followers: Game_Followers | undefined;
    _encounterCount: any;
    clearTransferInfo(): void;
    followers(): Game_Followers | undefined;
    refresh(): void;
    isStopping(): any;
    reserveTransfer(mapId: any, x: any, y: any, d: any, fadeType: any): void;
    setupForNewGame(): void;
    requestMapReload(): void;
    isTransferring(): boolean | undefined;
    newMapId(): any;
    fadeType(): any;
    ...
    getOnOffVehicle(): boolean | undefined;
    getOnVehicle(): boolean | undefined;
    getOffVehicle(): boolean | undefined;
    ...
    areFollowersGathering(): boolean | undefined;
...
declare class Game_Followers {
    ...
    gather(): void;
    areGathering(): boolean | undefined;
...
declare class Game_Vehicle {
    ...
    initMembers(): void;
    _mapId: any;
    _altitude: number | undefined;
    _driving: boolean | undefined;
    _bgm: any;
    isBoat(): boolean;
    isShip(): boolean;
    isAirship(): boolean;
...
declare class Game_Event {
    ...
    _moveType: any;
    _trigger: any;
    _starting: boolean | undefined;
    _erased: boolean | undefined;
    _pageIndex: any;
...
declare class Game_Interpreter {
    ...
    _indent: any;
    _frameCount: any;
    _freezeChecker: number | undefined;
    checkOverflow(): void;
    clear(): void;
    _mapId: any;
    _eventId: any;
    ...
    _waitCount: any;
    _waitMode: any;
    _comments: string | any[] | undefined;
    _characterId: any;
    _childInterpreter: Game_Interpreter | null | undefined;
