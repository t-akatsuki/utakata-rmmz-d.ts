...
declare class Window_Base {
    ...
    _dimmerSprite: Sprite | null | undefined;
    ...
    updateTone(): void;
    createContents(): void;
    contents: Bitmap | undefined;
    contentsBack: Bitmap | undefined;
    ...
    maxFontSizeInLine(line: any): number | undefined;
...
declare class Window_Scrollable {
    ...
    _scrollTargetX: any;
    _scrollTargetY: any;
    _scrollDuration: number | undefined;
    _scrollAccelX: any;
    _scrollAccelY: any;
    _scrollTouching: boolean | undefined;
...
declare class Window_Selectable {
    ...
    _helpWindow: any;
    _handlers: {} | undefined;
    _doubleTouch: boolean | undefined;
    _canRepeat: boolean | undefined;
    index(): any;
    cursorFixed(): any;
...
declare class Window_Command {
    ...
    addCommand(name: any, symbol: any, enabled?: boolean, ext?: null): void;
...
declare class Window_Message {
    ...
    clearFlags(): void;
    _showFast: boolean | undefined;
    _lineShowFast: boolean | undefined;
    _pauseSkip: boolean | undefined;
    update(): void;
...
declare class Window_BattleLog {
    ...
    _methods: any[] | undefined;
    _waitCount: number | undefined;
    _waitMode: any;
    _baseLineStack: any[] | undefined;
    _spriteset: any;
...
declare class Window_BattleStatus {
    ...
    openness: number | undefined;
    _bitmapsReady: number | undefined;
    extraHeight(): number;
    maxCols(): number;
    itemHeight(): any;
    maxItems(): any;
...
declare class Window_DebugRange {
    constructor(...args: any[]);
    initialize(rect: any): void;
    _maxSwitches: number | undefined;
    _maxVariables: number | undefined;
    maxItems(): number;
    update(): void;
